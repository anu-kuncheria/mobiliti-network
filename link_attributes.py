...
all_links_ca_uni = pd.read_csv('../data/midstages/mid_uni_links_correctphyslane.csv')
...
all_links_ca_uni.to_csv("../data/midstages/all_links_ca_uni_nolen.csv", index = False)
