...
sn = pd.read_csv(r'C:\Users\anuku\GSR\UCBerkeley_GSR\Networks_Dataset\from_Here\nav_street_for_mobiliti_links_shapenodes.csv', names = ['global_id','LINK_ID','nodes'])
...
#shape_nodes_unidirec.to_csv(r'C:\Users\anuku\GSR\UCBerkeley_GSR\Networks_Dataset\networks_dataset_Mobiliti\Nov2019\shapenodes_unidirec.csv', index = False)
'''

shape_nodes = pd.read_csv(r'C:\Users\anuku\GSR\UCBerkeley_GSR\Networks_Dataset\networks_dataset_Mobiliti\Nov2019\midstages\shapenodes_unidirec.csv')
